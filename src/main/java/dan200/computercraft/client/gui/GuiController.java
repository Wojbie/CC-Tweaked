...
public final class GuiController<T extends ContainerComputerBase> extends ComputerScreenBase<T>
{
    ...
    public static GuiController<ContainerPocketController> createPocketController( ContainerPocketController container, PlayerInventory inventory, ITextComponent component )
    {
